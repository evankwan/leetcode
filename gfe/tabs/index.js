...
const app = {
  ...
  initializeListeners: function () {
    this.selectors[TABS.HTML].addEventListener("click", (e) =>
      this.handleTabChange(e, TABS.HTML),
    );
    this.selectors[TABS.CSS].addEventListener("click", (e) =>
      this.handleTabChange(e, TABS.CSS),
    );
    this.selectors[TABS.JS].addEventListener("click", (e) =>
      this.handleTabChange(e, TABS.JS),
    );
  },
  init: function () {
